...
const Count: FC<CountProps> = ({ count, label, isLoading, array, isID, isWide }) => {
    ...
    return (<div className={`rounded h-40 ${isWide ? 'w-80': 'w-60'} flex flex-col ${isID ? 'border-4 border-gray-500': 'border border-gray-700 '} pt-5`}>
